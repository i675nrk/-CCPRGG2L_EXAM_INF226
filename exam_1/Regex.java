...
public class Regex {
    public static void main(String[] args) {
        ...
        pattern = Pattern.compile("[a-zA-Z37_\\.]{15,}\\b@\\b(gmail\\.com)");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("((http|https):\\/\\/)?(www\\.)?(cyrahsophiaangellacuenca)(\\b(\\.com)(\\.[a-zA-Z]*)?)(\\b\\/.*)?");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("((http|https):\\/\\/)[^ ]*", "");
